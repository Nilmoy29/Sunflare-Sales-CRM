-- Book a D2D appointment: contact + interested knock + pipeline lead + follow-up.
...
revoke all on function public.book_d2d_appointment(
  double precision,
  double precision,
  text,
  text,
...
grant execute on function public.book_d2d_appointment(
  double precision,
  double precision,
  text,
  text,
